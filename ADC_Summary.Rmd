...
# 	dcat <- read.table("./Input Files/adc_data_catalog_10-21-14.csv", header=TRUE, sep=",", na.strings = "")
# 	enr <- read.table("./Input Files/enrollment_10-21-14.csv", header=TRUE, sep=",", na.strings = "")
#   asl1 <- read.table("./Input Files/assesslist_10-21-14.csv", header=TRUE, sep=",", na.strings = "")
...
#### Average time by year between clinical evaluations \n of participants in the ADC longitudinal cohort
...
plot(mean_time_between ~ year, data=asl7, type="n",pch=1, xlim=c(2001,cur_yr), ylim=c(0.8,1.8),xlab="Year", ylab = "Average Time Between Evaluations")
...
#### Average time by year between the most recent clinical evaluations and January 1 of the index year
...
plot(mean_time_last ~ year, data=tmlstc, type="n",pch=1, xlim=c(2001,cur_yr), ylim=c(0.6,1.1), xlab="Year", ylab = "Average Time Since Last Evaluation")
