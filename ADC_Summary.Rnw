...
#	setwd("/Volumes/John Deere/dan/Database/Data Extraction/enrolled_survival_07-14/")
  ...
  cur_yr <- as.numeric(format(as.Date(date(), format="%a %b %d %H:%M:%S %Y"), "%Y")) 
	...
	dcat <- read.table("./Input Files/adc_data_catalog_09-10-14.csv", header=TRUE, sep=",", na.strings = "")
	enr <- read.table("./Input Files/enrollment_09-10-14.csv", header=TRUE, sep=",", na.strings = "")
...
dcat$grp2 <- ifelse(dcat$ETHNICITY==1,"Other",ifelse(dcat$ETHNICITY==2,"Other",ifelse(dcat$ETHNICITY==3,"Other",ifelse(dcat$ETHNICITY==4,"African American",ifelse(dcat$ETHNICITY==5,"Other",ifelse(dcat$ETHNICITY==6,"Hispanic",ifelse(dcat$ETHNICITY==7,"White",ifelse(dcat$ETHNICITY==8,"Other",NA))))))))
	...
	dcat$ClinDxMRA <- ifelse(dcat$ETIOLMRA==7 | dcat$ETIOLMRA==8 | dcat$ETIOLMRA==24,2,ifelse(dcat$ETIOLMRA==1 | dcat$ETIOLMRA==2,1,ifelse(dcat$ETIOLMRA==3 | dcat$ETIOLMRA==4,3,ifelse(dcat$ETIOLMRA==9,4,ifelse(dcat$ETIOLMRA==21,ifelse((dcat$MIX1MRA==1 | dcat$MIX1MRA==2) & (dcat$MIX2MRA==3 | dcat$MIX2MRA==4),5,ifelse((dcat$MIX1MRA==3 | dcat$MIX1MRA==4) & (dcat$MIX2MRA==1 | dcat$MIX2MRA==2),5,ifelse((dcat$MIX1MRA==7 | dcat$MIX1MRA==8 | dcat$MIX1MRA==24) & (dcat$MIX2MRA==1 | dcat$MIX2MRA==2),2,ifelse((dcat$MIX2MRA==7 | dcat$MIX2MRA==8 | dcat$MIX2MRA==24) & (dcat$MIX1MRA==1 | dcat$MIX1MRA==2),2,NA)))),NA)))))
	
	dcat$ClinDxMRA2 <- ifelse(dcat$SYNDRMRA==6,6,ifelse(dcat$SYNDRMRA %in% c(2,3),7,ifelse(dcat$ETIOLMRA==7 | dcat$ETIOLMRA==8 | dcat$ETIOLMRA==24,2,ifelse(dcat$ETIOLMRA==1 | dcat$ETIOLMRA==2,1,ifelse(dcat$ETIOLMRA==3 | dcat$ETIOLMRA==4,3,ifelse(dcat$ETIOLMRA==9,4,ifelse(dcat$ETIOLMRA==21,ifelse((dcat$MIX1MRA==1 | dcat$MIX1MRA==2) & (dcat$MIX2MRA==3 | dcat$MIX2MRA==4),5,ifelse((dcat$MIX1MRA==3 | dcat$MIX1MRA==4) & (dcat$MIX2MRA==1 | dcat$MIX2MRA==2),5,ifelse((dcat$MIX1MRA==7 | dcat$MIX1MRA==8 | dcat$MIX1MRA==24) & (dcat$MIX2MRA==1 | dcat$MIX2MRA==2),2,ifelse((dcat$MIX2MRA==7 | dcat$MIX2MRA==8 | dcat$MIX2MRA==24) & (dcat$MIX1MRA==1 | dcat$MIX1MRA==2),2,NA)))),NA)))))))
...
\section{Retention in Longitudinal Follow-up}
...
# Get the basic stats
table_data_cp[["1991-2006"]] <- getT1Stat("ClinDxMRA2","PathDx",dcat[!dcat$PathDx=="Other" & !dcat$PathDx=="LBD+CVD" & dcat$DtDeath >= as.Date("1991-10-01") & dcat$DtDeath < as.Date("2006-07-01"),])
table_data_cp[["1991-2006 Total"]] <- getT1Stat("ClinDxPres","PathDx",dcat[!dcat$PathDx=="Other" & !dcat$PathDx=="LBD+CVD" & dcat$DtDeath >= as.Date("1991-10-01") & dcat$DtDeath < as.Date("2006-07-01"),])
table_data_cp[["2006-2016"]] <- getT1Stat("ClinDxMRA2","PathDx",dcat[!dcat$PathDx=="Other" & !dcat$PathDx=="LBD+CVD" & dcat$DtDeath >= as.Date("2006-07-01") & dcat$DtDeath < as.Date("2016-07-01"),])
table_data_cp[["2006-2016 Total"]] <- getT1Stat("ClinDxPres","PathDx",dcat[!dcat$PathDx=="Other" & !dcat$PathDx=="LBD+CVD" & dcat$DtDeath >= as.Date("2006-07-01") & dcat$DtDeath < as.Date("2016-07-01"),])
table_data_cp[["1991-2016 Total"]] <- getT1Stat("ClinDxPres","PathDx",dcat[!dcat$PathDx=="Other" & !dcat$PathDx=="LBD+CVD" & dcat$DtDeath >= as.Date("1991-10-01") & dcat$DtDeath < as.Date("2016-07-01"),])
